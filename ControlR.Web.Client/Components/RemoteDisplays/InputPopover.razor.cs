...
public partial class InputPopover : DisposableComponent
{
  ...
  private async Task HandleReceiveClipboardClicked()
  {
    try
    {
      ...
      await ViewerHub.Server.AddViewerActivity2(new(DeviceAccessActivityNames.ReceiveClipboardText));
    }
    catch (Exception ex)
    {
  ...
  private async Task HandleSendClipboardClicked()
  {
    try
    {
      ...
      await ViewerHub.Server.AddViewerActivity2(new(DeviceAccessActivityNames.SendClipboardText));
    }
    catch (Exception ex)
    {
