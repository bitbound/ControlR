...
public class FakeFileSystem(char directorySeparator = '/', bool isCaseSensitive = false) : IFileSystem, IFileAccessPermissions
{
  ...
  public void Set(string filePath, bool includeCurrentUser, bool isProtected, bool preserveInheritance, WellKnownSidType? owner, params WellKnownSidType[] allowedSids)
  {
    lock (_syncRoot)
    {
      var normalizedPath = NormalizePath(filePath);
