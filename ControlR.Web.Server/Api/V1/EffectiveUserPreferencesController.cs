...
{
  [HttpGet]
  [ProducesResponseType<EffectiveDtos.EffectiveUserPreferencesDto>(StatusCodes.Status200OK)]
  [ProducesResponseType(StatusCodes.Status401Unauthorized)]
  [ProducesResponseType(StatusCodes.Status403Forbidden)]
  public async Task<ActionResult<EffectiveDtos.EffectiveUserPreferencesDto>> GetAll(
    ...
    CancellationToken cancellationToken)
  {
    ...
    return Ok(new EffectiveDtos.EffectiveUserPreferencesDto(
