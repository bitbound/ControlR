...
{
  async Task<ApiResult<CreatePersonalAccessTokenResponseDto>> IPersonalAccessTokensApi.CreatePersonalAccessToken(Guid tenantId, CreatePersonalAccessTokenRequestDto request, CancellationToken cancellationToken)
  {
  ...
  async Task<ApiResult<PersonalAccessTokensResponseDto>> IPersonalAccessTokensApi.GetPersonalAccessTokens(Guid tenantId, CancellationToken cancellationToken)
  {
    return await _client.ExecuteApiCall(async () =>
