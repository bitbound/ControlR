...
public sealed class SkiaBitmapDrawOperation(Rect bounds, Func<DisposableValue<SKBitmap?>> acquireBitmap) : ICustomDrawOperation
{
  private readonly Func<DisposableValue<SKBitmap?>> _bitmapAcquirer = acquireBitmap;
